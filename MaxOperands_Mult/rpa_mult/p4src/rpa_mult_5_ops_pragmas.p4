...
@pa_container_size("ingress", "meta.i", 16)
@pa_container_size("ingress", "meta.j", 16)
    ...
    out ingress_intrinsic_metadata_t  ig_intr_md)
{
    ...
    state parse_ff_calc {
        ...
        meta.i = hdr.ff_calc.i;
        meta.j = hdr.ff_calc.j;
        meta.result_0 = 0;
        meta.result_1 = 0;
        meta.result_2 = 0;
        meta.result_3 = 0;
    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    action action_ff_mult() {
        ...
        // ELEMENT 4
		meta.high_bit_f_4 = meta.i & HIGH_BIT_MASK;
    ...
    apply {
		...
		if (low_bit_f_4 != 0)
			meta.result_4 = meta.result_4 ^ meta.i;
		...
		if (meta.high_bit_f_4 != 0)
			meta.i = meta.i ^ IRRED_POLY;
        ...
        hdr.ff_calc.i = meta.i;
        hdr.ff_calc.j = meta.j;
        ...
        hdr.ff_calc.result_4 = meta.result_4;
...
@pa_container_size("egress", "meta.i", 8)
@pa_container_size("egress", "meta.j", 8)
    ...
    out egress_intrinsic_metadata_t  eg_intr_md)
{
    ...
    state parse_ff_calc {
        ...
        meta.result_4 = hdr.ff_calc.result_4;
        meta.high_bit_f_0 = 0;
        meta.high_bit_f_1 = 0;
        meta.high_bit_f_2 = 0;
        meta.high_bit_f_3 = 0;
